...
/// Which forge backs a remote, when known. Used to pick forge-specific
/// behaviors (e.g. how PRs are fetched) without having to encode every site
/// directly in the URL.
...
/// Parsed contents of a remote's josh config file.

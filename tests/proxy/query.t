...
Now render still works (used to fail if filtered previously)
  $ curl -s -i http://localhost:8002/real_repo.git?render=tmpl_file\&param_val=12345\&content-type=text/html | grep -v date:
...
Failing render for lack of variable
  ...
  content-length: 101\r (esc)
  date: *\r (esc) (glob)
  \r (esc)
  Error rendering "tmpl_file" line 1, col 8: Failed to access variable in strict mode Some("param_val") (no-eol)

  ...
  * add file1  (origin/master, origin/HEAD)
  ...
  remote: response from upstream:        
  remote: To http://localhost:8001/real_repo.git        
  remote:  * [new branch]      JOSH_PUSH -> @heads/other_branch/josh@example.com        
  remote: To http://localhost:8001/real_repo.git        
  remote:  * [new branch]      JOSH_PUSH -> @changes/other_branch/josh@example.com/1234        
  remote: To http://localhost:8001/real_repo.git        
  remote:  * [new branch]      JOSH_PUSH -> @changes/other_branch/josh@example.com/foo7        
  remote: 
  remote: 
  To http://localhost:8002/real_repo.git:/sub1.git

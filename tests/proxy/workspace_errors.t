...
Error in filter
  ...
  remote:   |         ^---        
  remote:   |        
  remote:   = expected EOI, filter_insert, filter_group, filter_subdir, filter_stored, filter_wasm, filter_treeid, filter_treeref, filter_treederef, filter_nop, filter_presub, filter, filter_noarg, filter_message, filter_rev, filter_unapply, filter_replace, filter_squash, filter_scope, or filter_meta        
  remote: 
  remote: a/b = :b/sub2        
  remote: c = :/sub1        
  remote: 

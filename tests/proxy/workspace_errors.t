...
Error in filter
  ...
  remote:   |         ^---        
  remote:   |        
  remote:   = expected EOI, filter_group, filter_subdir, filter_nop, filter_presub, filter, filter_noarg, filter_message, filter_rev, filter_from, filter_concat, filter_unapply, filter_join, filter_replace, or filter_squash        
  remote: 
  remote: a/b = :b/sub2        
  remote: c = :/sub1        
  remote: 

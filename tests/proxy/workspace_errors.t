...
Error in filter
  ...
  remote:   |         ^---        
  remote:   |        
  remote:   = expected EOI, filter_blob, filter_group, filter_subdir, filter_stored, filter_starlark, filter_nop, filter_presub, filter, filter_noarg, filter_message, filter_rev, filter_unapply, filter_replace, filter_squash, filter_scope, or filter_meta        
  remote: 
  remote: a/b = :b/sub2        
  remote: c = :/sub1        
  remote: 

...
Verify local cache refs were created
  ...
  refs/josh/cache/29/0/bf567e0faf634a663d6cef48145a035e1974ab1d

Push the distributed cache and filtered ref to the backing remote

  $ josh cache push
  To file://${TESTTMP}/remote/libs
   * [new reference]   refs/josh/cache/29/0/bf567e0faf634a663d6cef48145a035e1974ab1d -> refs/josh/cache/29/0/bf567e0faf634a663d6cef48145a035e1974ab1d
...
Fetch the distributed cache and filtered objects from the remote
  ...
  $ josh cache fetch
  From file://${TESTTMP}/remote/libs
   * [new ref]         refs/josh/cache/29/0/bf567e0faf634a663d6cef48145a035e1974ab1d -> refs/josh/cache/29/0/bf567e0faf634a663d6cef48145a035e1974ab1d

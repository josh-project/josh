  ...
  * add dirs
  ...
  $ josh-filter master --update refs/josh/filtered :DIRS
  ...
  * add dirs
  ...
  $ josh-filter master --update refs/josh/filtered :DIRS:/c
  ...
  * add dirs
  ...
  $ josh-filter master --update refs/josh/filtered :DIRS:/a
  ...
  * add dirs
  ...
  $ josh-filter master --update refs/josh/filtered :DIRS:hide=c:prefix=x
  ...
  * add dirs
  ...
  $ josh-filter master --update refs/josh/filtered :DIRS:FOLD
  ...
  * add dirs
  ...
  $ josh-filter master --update refs/josh/filtered :DIRS:/c:FOLD
  ...
  * add dirs
  ...
  $ josh-filter master --update refs/josh/filtered :DIRS:workspace=a:FOLD

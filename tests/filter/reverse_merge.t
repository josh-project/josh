  ...
  * add sub2
  ...
  $ josh-filter branch1 --update refs/heads/hidden_branch1 :hide=sub2
  ...
  $ josh-filter master --update refs/heads/hidden_master :hide=sub2
  ...
  * add file1
  ...
  $ josh-filter --reverse master --update refs/heads/hidden_master :hide=sub2

  ...
  * add sub2
  ...
  $ josh-filter :hide=sub2 branch1 --update refs/heads/hidden_branch1
  ...
  $ josh-filter :hide=sub2 master --update refs/heads/hidden_master
  ...
  * add file1
  ...
  $ josh-filter :hide=sub2 --reverse master --update refs/heads/hidden_master

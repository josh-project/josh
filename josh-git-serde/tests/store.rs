...
fn written_tree_is_in_canonical_order() {
    ...
    // Read the root tree's raw bytes back out of the staging store.
    ...
    // Entry oids point at the objects just written: blobs with matching
    // content, the tree entry at a tree containing "inner".
